...
*/
    ...
    double flight_range_E = ((M_PI * R_E * angle) / 180.0) * 1000;
    double flight_range_P = ((M_PI * R_P * angle) / 180.0) * 1000;
    double flight_range = ((M_PI * ((R_P + R_E) / 2) * angle) / 180.0) * 1000;
