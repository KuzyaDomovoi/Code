...
int main(void)
{
    ...
    case 1:
        ...
        printf("Удельный расход топл для ном ррд при наборе на средн выс: ");
        while(scanf("%lf", &spec_fucons) != 1) {
            printf("\nError_input!");
            return 0;
        }
        printf("Величина тяги для ТРДД при номинал ррд в наборе на средн выс: ");
