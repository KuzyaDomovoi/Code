...
void calcfldist_bear(double lat1, double lng1, double lat2, double lng2, double res[3]) {
    lat_1.lat = lat1 * RAD;
    lng_1.lng = lng1 * RAD;
    lat_2.lat = lat2 * RAD;
    lng_2.lng = lng2 * RAD;
    ...
    res[0] = flight_dist;
    res[1] = initial_bearing;
    res[2] = reverse_bearing;
...
int main(void)
{
    ...
    case 2:
        ...
        double res[3];
        calcfldist_bear(lat1, lng1, lat2, lng2, res);
