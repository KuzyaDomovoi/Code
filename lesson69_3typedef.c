...
//typedef unsigned char BYTE; // unlike the '#define' the 'typedef' statement is processed by the complier itself;
...
int main(void)
{
    ...
    PTR_INT a, b; // with using the '#define' statement are here pointer 'int* a' and var 'b' only (not 'int* b');
