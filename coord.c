...
void coord_transfer(double deg, int lat_res[2], float lat_res2[1], int lng_res[2], float lng_res2[1]) {
    int dd = trunc(deg);
...
int main(void)
{
    ...
    printf("lat  %02d° %02d' %.2f''\nlng %03d° %02d' %.2f''\n", 
            lat_res[0], lat_res[1], lat_res2[0], rlng_es[0], lng_res[1], lng_res2[0]);
