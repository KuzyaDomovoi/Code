...
int main(void)
{
    int turn_time, turn_time_m, turn_time_s, turn_rad, turn_roll, turn_angle, wind_angle, magnetpath_angle, aircr_speed, wind_dir, wind_speed;
    float drift_angle, graund_speed, speed, sa, a, wa, da;
